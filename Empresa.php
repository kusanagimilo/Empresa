            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="active"><a  href="Empresa.php">EMPRESAS</a></li>
                        ...
                        <div class="home-wrapper">
                            <div class="col-md-10 col-md-offset-1">
                                <div class="home-content">
                                    <div class="row">
                                        <div style="margin-top: -10%" class="col-md-7 col-md-offset-3 col-sm-12 col-xs-12">
                                            <h1>ENCUENTRA LOS MEJORES PROFESIONALES</h1>
                                            <form class="form" action="Busqueda.php" autocomplete="on" method="GET"> 
                                                <table class="table table-striped  table-bordered table-responsive" style="background-color: #ffffff">

                                                    <tr>
                                                        <td colspan="2"><b>Buscar profesional</b></td>
                                                    </tr>

                                                    <tr>
                                                        <td><input type="text" class="form-control" name="profesion_bus" id="profesion_bus"  placeholder="Ingresar profesion"></td>
                                                        <td>
                                                            <select class="form-control" name="disponibilidad_tiempo_bus" id="disponibilidad_tiempo_bus">
                                                                <option value="">Disponibilidad de tiempo</option>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <select class="form-control" name="disponibilidad_viajar_bus" id="disponibilidad_viajar_bus">
                                                        ...
                                                        <td>
                                                            <select class="form-control" name="restriccion_tran_bus" id="restriccion_tran_bus">
                                                                <option value="">Restriccion de transporte</option>
                                                                <option value="SI">SI</option>
                                                                <option value="NO">NO</option>
                                                            </select>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td colspan="2"><input class="btn btn-info" type="submit" value="BUSCAR PROFESIONAL"></td>
